...
const AnimatedThemeSwitch = ({ isDark, onToggle }) => {
  return (
    <StyledWrapper>
      <label className="theme-switch" title="Toggle Dark Mode">
        {/* React controls the checked state and listens for clicks here */}
        <input
          type="checkbox"
...
const StyledWrapper = styled.div`
  /* ALL YOUR EXISTING CSS REMAINS EXACTLY THE SAME BELOW */
  .theme-switch {
    --toggle-size: 12px; /* Note: You can adjust this to scale the entire component up or down */
